    ...
    function deleteById() {
        ...
        if(id) {deleteById()
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/system/role/delete.do?roleid="+id;
            }
        }else{
            ...
            <div class="table-box">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <td>${o.remark}</td>
                        <th class="text-center"><button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/system/role/toUpdate.do?roleid=${o.id}"'>编辑</button></th>
                    </tr>
                    </c:forEach>
                    </tbody>
                </table>
